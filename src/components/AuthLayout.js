        ...
        <aside className="login-illustration-pane">
          <div className="login-illustration-content">
            <div className="login-logo-center-group">
              <img src="/deal360-logo.svg" alt="Deal 360 Logo" className="login-logo-image-center" />
            </div>
            <img src="/erp_dashboard.png" alt="Portal Illustration" className="login-main-illustration" />
          </div>
        </aside>
